...
Веб-интерфейс доступен по адресу `/ui` после запуска сервера. Он упрощает тестирование и взаимодействие с API, делая процесс вычисления выражений более наглядным и удобным для пользователей.
...
Подробнее об этом написано в разделе "Документация".
